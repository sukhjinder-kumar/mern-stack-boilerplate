...
const Profile = (props) => {
  ...
  const onSubmit_Buyer = (event) => {
    ...
    axios
      .post("http://localhost:5000/buyers/update/" + id, newUser)
      .then((response) => {
  ...
  const onSubmit_Vendor = (event) => {
    ...
    axios
      .post("http://localhost:5000/vendors/update/" + id, newUser)
      .then((response) => {
  ...
  useEffect( () => {
    ...
    if(occupation == "Buyer") {
      axios
        .post("http://localhost:5000/buyers/profile", Email)
        .then(res => {
    ...
    if(occupation == "Vendor") {
      axios
        .post("http://localhost:5000/vendors/profile", Email)
        .then(res => {

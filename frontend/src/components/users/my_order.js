...
const My_Order= (props) => {
    ...
    var vendor_name = (vendor_id_) => {
        ...
        axios 
            .get("http://localhost:5000/vendors/" + vendor_id_)
            .then(res => {
    ...
    const MakeItComplete = (key) => {
        ...
        axios 
            .post("http://localhost:5000/orders/update_buyer/" + key, status_)
            .then( res => {
    ...
    const ToCancel = (key) => {
        ...
        axios 
            .post("http://localhost:5000/orders/cancel/" + key)
            .then( res => {
                console.log(res);
                console.log("Status updated");
            })
    ...
    const GiveRating = (key) => {
        ...
        axios 
            .post("http://localhost:5000/orders/give_rating/" + key, rating_)
            .then(res => {
    ...
    useEffect( () => {
        ...
        axios
            .get("http://localhost:5000/orders/particular_buyer/" + buyer_id)
            .then(response => {
